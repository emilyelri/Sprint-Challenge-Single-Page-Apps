...
> Answer: The benefits of client-side routing are that the page doesn't need to reload once it's loaded once, so after the initial load time, the user has a much faster experience of navigating the page.
